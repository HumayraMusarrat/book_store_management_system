...
<html lang="en">
  ...
  <body style="background-color: gray">
    ...
    <nav class="navbar bg-info navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Bluemoon BookStore</a>
        </div>
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="admin.php"><span class="glyphicon glyphicon-paperclip"></span>&nbsp; Admin Login</a></li>
    ...
    <div class="jumbotron" style="background-color: gray">
      <div class="container">
        <h1>Welcome to Bluemoon Book Store</h1>
        <p class="lead"></p>
        <p>
      </div>
    </div>
